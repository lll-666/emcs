 ...
 */
public class VMin extends AbstractValidationFilter {
    ...
    public void doFilter(Map<String, Object> rule, Map<String, Object> validationResult) {
        ...
        if(vName != null && CommonConstant.Validation.VMIN.equals(vName)){
            //获取要校验的字段名
            ...
            //开始校验
            if(vCValue.toString().compareTo(vRValue.toString()) == 1){
                //添加校验结果
